...
<form action="sms.php" class="bomber-form" method="POST">
    ...
    <input id="phone" name="phone" placeholder="09127984784" type="text">
    <button onclick="sending()" name="submit">ارسال</button>
    <a href="ن" target="_blank"><img alt="https://www.digikala.com/" class="google"
                                                                 src="assets/img/Untitled-3.png"></a>
</form>
<script>
    function sending() {
